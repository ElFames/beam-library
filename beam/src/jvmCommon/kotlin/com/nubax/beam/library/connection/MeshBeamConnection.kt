...
internal class MeshBeamConnection(
    ...
    private suspend fun onBeaconReceived(beacon: Beacon, address: String) {
        ...
        // (pairDesktopWithCode) — nunca algo que dispare el discovery pasivo.
        if (!trusted) return
        ...
        // Móvil y Desktop son simétricos (los dos pueden iniciar o aceptar) — se
     ...
     * — ver PROJECT.md §2.4 para el flujo de código de Desktop, y la rama `else` de
     * más abajo para el caso "ni vinculado, ni intención, ni auto-link de acceptor:
     * rechazar".
     */
