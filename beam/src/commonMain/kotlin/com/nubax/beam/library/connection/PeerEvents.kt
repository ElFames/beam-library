 ...
 * `PairingRequestEvent`/fingerprint-a-confirmar: ahora la confirmación la dan las
 * credenciales del pinganillo o el código de Desktop, no un código a comparar.
 */
